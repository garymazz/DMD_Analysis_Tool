...
class DMDFramework(App):
    ...
    @staticmethod
    def _requested_operation_label() -> str | None:
        # Fast path: avoid Cement handler inspection for global `--help`.
        # The first non-flag token is treated as a potential operation label.
